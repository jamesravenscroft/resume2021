...
<img src="https://ak2.picdn.net/shutterstock/videos/16196992/thumb/11.jpg" alt="bestFriends"
    style={{width:"30%"}}
    />
<h4 className="pt-100 pb-30"><a href="https://friend-finder2341.herokuapp.com/">Friend Finder</a></h4>
<p style={{color:"black"}}>
...
<Col sm><a href="https://jamesravenscroft.github.io/unit-4-game/">
       ...
       <p className=" pb-100">Dune Fightin Game<br></br>
...
<a href="https://jamesravenscroft.github.io/TriviaGame/">
  ...
  <p className=" pb-100"  style={{color:"black"}}>The Gom Jabbar<br></br>
...
<img src={require("../img/gifTime.PNG")} alt="gifTime"
    style={{width:"60%"}}
    />
<h4 className="pt-100 pb-30"><a href="https://jamesravenscroft.github.io/gifTime/">Bestest Directors Gifs</a></h4>
<p style={{color:"black"}}>
...
<img className="img-fluid" src={require("../img/fvCover.jpg")} style={{width:"25%"}} alt="voyage"/>
  <p className=" pb-100"  style={{color:"black"}}>Fantastic Voyage<br></br>
Train Scheduler	
    </p>
...
// <div className="dunebg">
// <br><h1 className="whiteout">Dune Series Games - Based on the Novels by Frank Herbert</h1>
// <div className="single-project">
//     <h4 className="pt-30 pb-30"><a href="https://jamesravenscroft.github.io/unit-4-game/">The Ballad of the Kwizats Haderach</h4>
//     <p className=" pb-100">
// Become the Pinnacle of Human evolution.				
//     </p>								
//     <img className="img-fluid" src="img/duneBalladOfKwizatzHarderachMedium.PNG" alt="" href="https://jamesravenscroft.github.io/unit-4-game/">
// </a>
// </div>
// <div className="single-project">
//     <h4 className="pt-100 pb-30"><a href="https://jamesravenscroft.github.io/TriviaGame/">The Gom Jabbar</h4>
//     <p className=" pb-30">
// You are smart. You are brave. Can you pass this test with your life on the line?			
//     </p>
//     <img className="img-fluid" src="img/GomJabbar.PNG" alt="">	
// </a>							
// </div>		
// </div>
// <!--dune end-->						            
...
// <div className="single-project">
// <h4 className="pt-30 pb-30"><a href="https://market-snapshot.herokuapp.com/">Market Snapshot</a></h4>
// <p className=" pb-100">
// Get an at-a-glance view of all Home and Condo Sales in San Diego County!
// </p>								
// <img className="img-fluid" src="img/Market_snap_logo.PNG" alt="">
// </div>
// <div className="single-project">
// <h4 className="pt-100 pb-30"><a href="https://github.com/jamesravenscroft/liriHomeworki">Node CLI App</a></h4>
// <p className=" pb-30">
// Find concerts, movies and music all using the command line in Terminal!
// </p>
// <img className="img-fluid" src="https://github.com/gregoryschmidt/market_snapshot/blob/master/public/images/Market_snap_logo.png" alt="Market Snapshot">		      
...
//    <div className="slideUp">  <img src="assets/images/zeldaWordGuessGameThumb.PNG" alt="Mountains" width="300" height="200">
//     </a>
//     <div className="desc">Legend of Zelda Word Guess</div></div>
//   </div>
// </div>
