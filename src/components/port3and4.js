  <section id="portfolio3">
        <div className="row">
          <div className="twelve columns collapsed">
            ...
            {/* portfolio-wrapper */}
            <div id="portfolio-wrapper3" className="bgrid-quarters s-bgrid-thirds cf">
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <a href="#modal-01" title>
                  <img alt="" src={process.env.PUBLIC_URL + '/images/portfolio/angular8routing.jpg'} />
                    <div className="overlay">
                      <div className="portfolio-item-meta">
                        <h5>Angular 8 Routing</h5>
                        <p>Illustrration</p>
                      </div>
                    </div>
              ...
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <a href="#modal-02" title>
                    <img alt="" src={process.env.PUBLIC_URL + '/images/portfolio/console.jpg'} />
                    <div className="overlay">
                      <div className="portfolio-item-meta">
                        <h5>Console</h5>
                        <p>Web Development</p>
              ...
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <a href="#modal-03" title>
                    <img alt="" src={process.env.PUBLIC_URL + '/images/portfolio/judah.jpg'} />
                    <div className="overlay">
                      <div className="portfolio-item-meta">
                        <h5>Judah</h5>
                        <p>Webdesign</p>
              ...
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <a href="#modal-04" title>
                    <img alt="" src={process.env.PUBLIC_URL + '/images/portfolio/into-the-light.jpg'} />
                    <div className="overlay">
                      <div className="portfolio-item-meta">
              ...
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <a href="#modal-05" title>
                    <img alt="" src={process.env.PUBLIC_URL + '/images/portfolio/farmerboy.jpg'} />
                    <div className="overlay">
                      <div className="portfolio-item-meta">
                        <h5>Farmer Boy</h5>
                        <p>Branding</p>
              ...
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <a href="#modal-06" title>
                    <img alt="" src={process.env.PUBLIC_URL + '/images/portfolio/girl.jpg'} />
                    <div className="overlay">
                      <div className="portfolio-item-meta">
                        <h5>Girl</h5>
                        <p>Photography</p>
              ...
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <a href="#modal-07" title>
                    <img alt="" src={process.env.PUBLIC_URL + '/images/portfolio/origami.jpg'} />
                    <div className="overlay">
                      <div className="portfolio-item-meta">
                        <h5>Origami</h5>
                        <p>Illustrration</p>
              ...
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <a href="#modal-08" title>
                    <img alt="" src={process.env.PUBLIC_URL + '/images/portfolio/retrocam.jpg'} />
                    <div className="overlay">
                      <div className="portfolio-item-meta">
                        <h5>Retrocam</h5>
                        <p>Web Development</p>
          ...
          <div id="modal-01" className="popup-modal mfp-hide">
            <img className="scale-with-grid" src={process.env.PUBLIC_URL + '/images/portfolio/modals/m-coffee.jpg'} alt="" />
